...
Preprocessing is a way to compile your data and generate css from the compiler's own syntax.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble? My favorite concept is when my compiler watches for changes I make. I think that's really cool. My least favorite subject is the mixins. 

3. How would you explain the concept of a variable to someone new to programming? A variable is like a container. it is a way to store data to be used later in the code. 

4. What is the purpose of using functions in code?
Functions are like mini programs. They allow us to create steps for the computer to go through. Like a set of instructions. 

5. What is a JSON data?
JavaScript Object Notation. The way objects are written.
